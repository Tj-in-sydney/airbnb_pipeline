...
CREATE TABLE BRONZE.RAW_AIRBNB (
    ...
    AVAILABILITY_30 VARCHAR(255),  
    NUMBER_OF_REVIEWS VARCHAR(255), 
    REVIEW_SCORES_RATING VARCHAR(255),  
    REVIEW_SCORES_ACCURACY VARCHAR(255),  
    REVIEW_SCORES_CLEANLINESS VARCHAR(255), 
    REVIEW_SCORES_CHECKIN VARCHAR(255),  
    REVIEW_SCORES_COMMUNICATION VARCHAR(255), 
    REVIEW_SCORES_VALUE VARCHAR(255)  
);


CREATE TABLE BRONZE.RAW_LGA_G01 (
...
CREATE TABLE BRONZE.RAW_LGA_G02 (
    LGA_CODE_2016 VARCHAR(255) PRIMARY KEY,
